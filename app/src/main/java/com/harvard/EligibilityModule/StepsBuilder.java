            ...
            for (int i = 0; i < activityQuestionStep.size(); i++) {
                if (activityQuestionStep.get(i).getType().equalsIgnoreCase("question")) {
                    switch (activityQuestionStep.get(i).getResultType()) {
                        ...
                        case "imageChoice":
                            QuestionStepCustom multichoiceStep = new QuestionStepCustom(activityQuestionStep.get(i).getKey(),false,"","","","","","","","","",null,null);
                        ...
                        case "textChoice":
                            if (activityQuestionStep.get(i).getFormat().getSelectionStyle().equalsIgnoreCase("Single")) {
                                ...
                                QuestionStepCustom multiStep = new QuestionStepCustom(activityQuestionStep.get(i).getKey(),false,"","","","","","","","","",null,null);
