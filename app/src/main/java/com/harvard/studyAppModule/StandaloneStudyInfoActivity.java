    ...
    public <T> void asyncResponse(T response, int responseCode) {
        if (responseCode == SPECIFIC_STUDY) {
            ...
            if (studies != null) {
                ...
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.title), "" + mStudy.getStudies().get(0).getTitle());
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.bookmark), "" + mStudy.getStudies().get(0).isBookmarked());
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.status), "" + mStudy.getStudies().get(0).getStatus());
                if (!studies.getStudies().isEmpty())
                    AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.studyStatus), "" + studies.getStudies().get(0).getStatus());
                else
                    AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.studyStatus), "yetToJoin");
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.position), "" + 0);
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.enroll), "" + mStudy.getStudies().get(0).getSetting().isEnrolling());
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.rejoin), "" + mStudy.getStudies().get(0).getSetting().getRejoin());
                AppController.getHelperSharedPreference().writePreference(StandaloneStudyInfoActivity.this, getString(R.string.studyVersion), "" + mStudy.getStudies().get(0).getStudyVersion());
