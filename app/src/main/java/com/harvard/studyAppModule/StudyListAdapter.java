...
public class StudyListAdapter extends RecyclerView.Adapter<StudyListAdapter.Holder> {
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        ...
        if(Locale.getDefault().getLanguage().equalsIgnoreCase("es") && mItems.get(position).getStudyLanguage().equalsIgnoreCase("spanish")){
                holder.mStudyLanguage.setText(" ");
        }
        else if(Locale.getDefault().getLanguage().equalsIgnoreCase("es") && mItems.get(position).getStudyLanguage().equalsIgnoreCase("english")){
                holder.mStudyLanguage.setText(mContext.getResources().getString(R.string.study_list_adapter_english_language).toUpperCase());
            }
        else if(Locale.getDefault().getLanguage().equalsIgnoreCase("en") && mItems.get(position).getStudyLanguage().equalsIgnoreCase("spanish"))
        {
                holder.mStudyLanguage.setText(mContext.getResources().getString(R.string.study_list_adapter_spanish_language).toUpperCase());
         }
        else if(Locale.getDefault().getLanguage().equalsIgnoreCase("en") && mItems.get(position).getStudyLanguage().equalsIgnoreCase("english"))
        {
            holder.mStudyLanguage.setText(" ");
        }

        //Log.e("Krishna", "onBindViewHolder: "+mItems.get(position).getStudyLanguage().toUpperCase() + "lang " + Locale.getDefault().getDisplayLanguage());
        GradientDrawable bgShape = (GradientDrawable) holder.mStateIcon.getBackground();
        Log.e("Krishna", "onBindViewHolder:status of study "+mItems.get(position).getStatus());
        Log.e("Krishna", "onBindViewHolder:studystatus of studyid , studyName and language " + mItems.get(position).getStudyId() + " "  + mItems.get(position).getTitle() + " " + mItems.get(position).getStudyLanguage() + " locale lang " + Locale.getDefault().getLanguage() + "  status of study " + mItems.get(position).getStudyStatus());
        Log.e("Krishna", "onBindViewHolder:study category " + mItems.get(position).getStudyId() + " "  + mItems.get(position).getTitle() + " " + mItems.get(position).getStudyLanguage() + " locale lang " + Locale.getDefault().getLanguage() + "  status of study " + mItems.get(position).getStudyStatus());
        if (mItems.get(position).getStatus().equalsIgnoreCase("active")) {
//            if(Locale.getDefault().getLanguage().equalsIgnoreCase("es")){
//                if(mItems.get(position).getStudyLanguage().equalsIgnoreCase("english")){
//
//                    holder.mState.setText(((StudyActivity) mContext).getBaseContext().getApplicationContext().getResources().getString(R.string.study_list_adapter_mState_active).toUpperCase());
...
//            }else {
                    ...
                    holder.mState.setText(((StudyActivity) mContext).getResources().getString(R.string.study_list_adapter_mState_active).toUpperCase());
                    bgShape.setColor(mContext.getResources().getColor(R.color.bullet_green_color));
