...
public class SingleChoiceTextQuestionBody<T> implements StepBody, CompoundButton.OnCheckedChangeListener {
    //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
    // Constructor Fields
    //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
    private QuestionStepCustom step;
    private StepResult<T[]> result;
    private SingleChoiceTextAnswerFormat format;
    ...
    public SingleChoiceTextQuestionBody(Step step, StepResult result) {
        ...
        this.format = (SingleChoiceTextAnswerFormat) this.step.getAnswerFormat1();
