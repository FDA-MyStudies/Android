...
public class SignupFragment extends Fragment implements ApiCall.OnAsyncRequestComplete {
    ...
    private void callRegisterUserWebService() {
        ...
        if (mPassword.getText().toString().equalsIgnoreCase("") && mEmail.getText().toString().equalsIgnoreCase("") && mConfirmPassword.getText().toString().equalsIgnoreCase("")) {
            ...
            Toast.makeText(mContext, getResources().getString(R.string.sign_up_activity_password_empty), Toast.LENGTH_SHORT).show();
        } else if (!mPassword.getText().toString().matches(PASSWORD_PATTERN)) {
            SetDialogHelper.setNeutralDialog(mContext, getResources().getString(R.string.sign_up_activity_password_validation), false, mContext.getResources().getString(R.string.sign_up_activity_ok_btn), mContext.getResources().getString(R.string.app_name));
        } else if (checkPasswordContainsEmailID(mEmail.getText().toString(), mPassword.getText().toString())) {
            Toast.makeText(mContext, getResources().getString(R.string.sign_up_activity_password_contain_email), Toast.LENGTH_SHORT).show();
        } else if (mConfirmPassword.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(mContext, getResources().getString(R.string.sign_up_activity_confirm_password_empty), Toast.LENGTH_SHORT).show();
        } else if (!mPassword.getText().toString().equals(mConfirmPassword.getText().toString())) {
            Toast.makeText(mContext, getResources().getString(R.string.sign_up_activity_password_mismatch_error), Toast.LENGTH_SHORT).show();
        } else if (!mAgree.isChecked()) {
            Toast.makeText(mContext, getResources().getString(R.string.sign_up_activity_terms_and_condition_validation), Toast.LENGTH_SHORT).show();
        } else {
            try {
    ...
    public <T> void asyncResponse(T response, int responseCode) {
        ...
        if (responseCode == REGISTRATION_REQUEST) {
            ...
            if (mRegistrationData != null) {
                ...
                Toast.makeText(mContext, mContext.getResources().getString(R.string.sign_up_activity_unable_to_signup), Toast.LENGTH_SHORT).show();
            }
