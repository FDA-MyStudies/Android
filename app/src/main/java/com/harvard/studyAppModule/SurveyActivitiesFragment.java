      ...
      if (activityListData
        ...
        if (calculateEndDate
          ...
          if (activityListData.getActivities().get(i).getActivityId()
              .equalsIgnoreCase("ActiveRFtrue")) {
            Log.e(activityListData.getActivities().get(i).getActivityId(),
                "" + activityListData.getActivities().get(i).getStartTime() + "   "
                    + activityListData.getActivities().get(i).getEndTime() + "   " + calendar
                    .getTime());
          }
        }
      } else if (activityListData
      ...
      if (activityListData.getActivities().get(i).getFrequency().isAddNewRuns()) {
        ...
        if ((mArrayList.get(j).getActivities() == null) || (
            ...
            !isDatesOverlapping(
                ...
                startCalendar,
                endCalendar,
                simpleDateFormat, false) && (!mArrayList.get(j).getExternalPropertyId()
          ...
          updateRunsToActivityListAPIData(
            ...
            startCalendar,
            endCalendar,
            simpleDateFormat, true) && (mArrayList.get(j).getExternalPropertyId()
            .equalsIgnoreCase(mArrayList.get(j).getActivities().getAnchorDateVersion())) && (
            ...
            for (int f = 0; f < mArrayList.get(j).getActivities().getCustomScheduleRuns().size();
              ...
              if (f < mArrayList.get(j).getActivities().getCustomScheduleRuns().size() - 1) {
                ...
                if (simpleDateFormat.parse(
                    mArrayList.get(j).getActivities().getCustomScheduleRuns().get(k)
