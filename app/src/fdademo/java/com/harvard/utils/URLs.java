...
public class URLs {
    ...
    public static String BASE_URL_WCP_SERVER = "https://wcp.demo.mystudiesapp.org/StudyMetaData/"; //UAT
//    public static String BASE_URL_WCP_SERVER = "http://192.168.0.44:3429/StudyMetaData/"; //UAT
    public static String BASE_URL_REGISTRATION_SERVER = "https://reg.demo.mystudiesapp.org/fdahpUserRegWS/"; //UAT
//    public static String BASE_URL_REGISTRATION_SERVER = "https://hpreg-stage.lkcompliant.net/fdahpUserRegWS/"; //UAT
    public static String BASE_URL_RESPONSE_SERVER = "https://resp.demo.mystudiesapp.org/"; //UAT
